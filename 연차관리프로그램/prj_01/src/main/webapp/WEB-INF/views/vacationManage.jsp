...
<script>
	...
	function saveClick(){
		var data = $(".vac_count").val();
		var obj = $("[name='update_form']");
		obj.find("[name='update_vac']").val(data);
...
<body>
        ...
        <div style="height:5px"></div>
            ...
            <c:forEach var="vaclist" items="${requestScope.vacationList}" varStatus="loopTagStatus">
            	<tr>
            		...
            		<td style="width: 30px;"><input type="text" class="vac_count" placeholder="남은일수" size="4" value="${vaclist.vac_count}"></td>
    ...
    <center>
     ...
     <form name="update_form">
     	<input type="hidden" name="update_vac" value="">
     </form>
