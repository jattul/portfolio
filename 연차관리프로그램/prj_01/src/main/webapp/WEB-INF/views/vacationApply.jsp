...
<script>
	...
	function applySave(){
		...
		var obj2 = endVal.split('-').join('');
		        ...
		        // 휴가 1일 , 반차일때 유효성 체크
		        if(obj1==obj2){
		        	var tot = ($("[name='vacationDays']").val * 10)
		        	if(tot==10){
		        		if(tot==5){ return; }
		        		return;
		        	}else{
		        		alert("휴가 일수가 잘못되었습니다.")
		        	}
		        }else if(obj1<obj2)
		        	startVal = "";
		        	endVal = "";
    ...
    <div style="height:30px"></div>
     <h3>휴가신청</h3>
        <table class="mainTable" border="1" cellpadding="5" style="border-collapse:collapse" align="center" width="80%"> 
            ...
            <tr>
	            <th>휴가 기간</th>
	            <td><input type="date" id="vac_date" name="applyStartDate" min="sysdate" max="2099-12-31"/>~
	            	<input type="date" id="vac_date" name="applyEndDate" min="sysdate" max="2099-12-31"/></td>
	            <th>휴가 일수</th>
