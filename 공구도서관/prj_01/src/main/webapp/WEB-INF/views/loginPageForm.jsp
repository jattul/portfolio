...
.loginBtn{
	height: 30px;
	color:rgb(0, 0, 0);
	background-color:rgb(217, 209, 199);
	border: none;
	font-size:18px;
		...
		<br>
	      <h2>로그인</h2>
	          <tr><br>
	           ...
	           <!--  <p class="chk_id"><input type="checkbox"  name="" ${empty cookie.mid.value?'':'checked'}>이메일 저장</p>
	            -->
	            <!--쿠키값 사용 일단 생략--><br>
	            <input type="button"  value="로그인" style="width:180px; font-size:17px; font-weight:bold;  border-radius: 12px;" class="loginBtn">
	            <td class="links">
				<br>
				<!--  
	              <span style="cursor:pointer;"  class="findEmail">이메일 찾기</span> | 
	              <span style="cursor:pointer;" class="findPwd">비밀번호 찾기</span> | -->
	              <table><input type="button" value="회원가입"  style="font-size:17px;  width:180px; font-weight:bold;  border-radius: 12px;" class="join"></table>
	            </td>
	          </tr>
	  </table>
	</div>
