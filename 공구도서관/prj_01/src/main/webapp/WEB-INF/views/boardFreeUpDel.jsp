...
<input type="hidden" name="no" value="${boardFreeInfo.no}">
    <center>
        ...
        <table border="1" cellpadding="5" style="border-collapse:collapse" align="center"> 
                    <tr>
                        ...
                        <td>
                        <input type="text" name="title"  id="title" class="text" size="40" maxlength="30" value = "${boardFreeInfo.title}">
                        </td>
                    </tr>
                    <tr>
                        <th class="tableTitle">내 용</th>
                        <td>
                        <textarea name="content"  id = "content" class="text" rows="13" cols="40"  maxlength="300">${boardFreeInfo.content}</textarea>
                        </td>
                    </tr>
        </table>
        <div style="height:15px;"></div>

        <input type="button" value="수정완료" class="upDelBtn" onClick="goUpdate();">
        <input type="button" value="취소" class="upDelBtn" onClick="goBoardFree();">
    </center>
    </form>
