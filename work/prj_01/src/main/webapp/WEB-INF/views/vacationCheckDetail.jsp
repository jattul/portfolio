...
<body>
    ...
    <div style="height:30px"></div>
      <center><h3>휴가 결재 상세보기</h3></center>
      
      
      <div class="detailUpperBtn">
	     <input type="button" value="승인" onClick="check();">
	     <input type="button" value="반려" onClick="notCheck();">
      </div>
      ...
      <center>
        <table class="mainTable" border="1" cellpadding="5" style="border-collapse:collapse" align="center" width="80%"> 
			...
			<input type="hidden" name="vac_use_no" value="${requestScope.checkDetail.vac_use_no}">
            <tr>
            	<th>신청일</th>
            ...
            <tr>
            	<th>휴가 기간</th>
            	<td><input type="text" name="applydate" value="${requestScope.checkDetail.start_date}" readonly>
            		~<input type="date" name="applydate" value="${requestScope.checkDetail.end_date}" readonly></td>
            	<th>휴가 일수</th>
            	<td><input type="text" name="vacationDays" value="${requestScope.checkDetail.tot_date}" readonly>일</td>
            </tr>        
            <tr>
            	<th>신청사유</th>
            	<td colspan="3">
            		<input type="text" name="reason" size=20 value="${requestScope.checkDetail.reason}" readonly>
            	</td>          
            </tr>
        </table>
